...
export const en = {
  ...
  'location.safety.start': 'Turn on',
  'location.safety.stop': 'Turn off',
  ...
  'location.safety.freeRemaining': 'Free plan: {mins} min of watching left today',
  'location.safety.freeNoteBody': 'One Roof Plus keeps it running for hours, not minutes',
  'location.safety.startedFreeTitle': 'Watching for {mins} min',
  'location.safety.startedFreeBody': 'The free plan includes one 30-minute safety radius a day. One Roof Plus removes the daily limit and keeps a radius running for hours, not minutes.',
  'common.notNow': 'Not now',
  'location.safety.startedFree': 'Watching for {mins} min · Plus removes the daily limit',
  'location.safety.usedToday': 'Today\'s watching time is used up',
  'location.safety.usedTodayBody': 'One Roof Plus removes the daily limit and keeps a radius running for hours, not minutes.',
  'location.safety.getPlus': 'Get One Roof Plus',
  'location.safety.endsInMin': 'Ends in about {mins} min',
  'location.safety.endedTitle': 'Safety radius ended',
  'location.safety.endedBody': 'Nobody is being watched now. The free plan includes {mins} minutes of watching a day — One Roof Plus keeps it running.',
  ...
  'pets.cropTitle': 'Frame the photo',
  'pets.cropHint': 'Pinch to zoom, drag to move',
  'pets.cropUse': 'Use photo',
  ...
  'settings.colorScheme': 'Colour',
  'settings.scheme.sunset': 'Sunset',
  'settings.scheme.clay': 'Clay',
  'settings.scheme.honey': 'Honey',
  'settings.scheme.harbor': 'Harbor',
  'settings.scheme.plum': 'Plum',
  'settings.scheme.field': 'Field',
  'settings.scheme.mono': 'Mono',
  'settings.scheme.slateOrange': 'Slate Orange',
  'settings.scheme.slateRed': 'Slate Red',
  'settings.scheme.slateBlue': 'Slate Blue',
  'settings.scheme.slateGreen': 'Slate Green',
