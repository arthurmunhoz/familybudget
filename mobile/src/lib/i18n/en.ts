...
export const en = {
  ...
  'location.tapHint': 'Tap a name for details',
  'location.you': 'You',
  'location.live': 'Live',
  'location.recenter': 'Recenter',
  'location.openSharing': 'Sharing settings',
  ...
  'location.safety.subtitle': 'Get alerted if someone leaves the circle',
  ...
  'location.safety.radius': 'Radius',
  'location.safety.center': 'Centered on you',
