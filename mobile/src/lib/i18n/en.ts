...
export const en = {
  ...
  'location.safety.freeNote': 'Free plan: one {mins}-minute radius a day',
  ...
  'location.safety.usedToday': 'Today\'s safety radius is used up',
  ...
  'location.safety.endedBody': 'Nobody is being watched now. The free plan includes one 30-minute radius a day — One Roof Plus keeps it running.',
