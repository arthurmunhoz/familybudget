...
--   migration-061-member-locations.sql (member_locations: one row/member with latest fix + sharing/paused_until state, household-scoped RLS + Realtime — backs the Whereabouts family-location app)
