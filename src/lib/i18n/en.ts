...
export const en = {
  ...
  'drawer.homeCity': 'Home city',
  'drawer.homeCityHint': "Set your city for today's weather at home",
  'drawer.cityPlaceholder': 'e.g. Austin',
  'drawer.setCity': 'Set',
  'drawer.cityNotFound': "Couldn't find that city. Try a different spelling.",
  ...
  'budget.freeLimit': 'Free households can have one budget. Ask an admin about One Roof Plus for more.',
  ...
  // Pet Care routines (migration 069).
  ...
  'petcare.saveTaskFailed': 'Could not save the routine — please try again.',
  'petcare.taskTitleHint': 'Task name…',
  'petcare.intervalDays': 'Repeat every (days)',
  'petcare.every': 'every {days}d',
  'petcare.dueNow': 'Due',
  'petcare.inDays': 'in {days}d',
  'petcare.markDone': 'Mark done today',
  'petcare.moveUp': 'Move up',
  'petcare.moveDown': 'Move down',
  'petcare.today': 'Today',
  ...
  'petcare.noWeights': 'No weights logged yet.',
  ...
  // Whereabouts (web). The web CAN'T do background location or geofence alerts â
  // these strings must keep saying so rather than implying always-on tracking.
  'app.location.name': 'Whereabouts',
  'app.location.desc': 'See where everyone is',
  'location.webLimit': 'On the web your location updates only while this page is open. For always-on sharing and place alerts, use the iPhone app.',
  'location.noMapToken': 'The map needs a Mapbox token (VITE_MAPBOX_TOKEN). The family list below still works without it.',
  'location.mySharing': 'My location',
  'location.sharingOn': 'Sharing while this page is open',
  'location.sharingOff': 'Not sharing',
  'location.sharingPaused': 'Paused',
  'location.sharing': 'Sharing',
  'location.start': 'Share',
  'location.stop': 'Stop',
  'location.pause1h': 'Pause for 1 hour',
  'location.resume': 'Resume sharing',
  'location.permDenied': "Couldn't get your location. Allow location access for this site and try again.",
  'location.noGeo': 'Not available on this browser',
  'location.tabFamily': 'Family',
  'location.tabPlaces': 'Places',
  'location.tabActivity': 'Activity',
  'location.nobodySharing': 'Nobody is sharing their location right now.',
  'location.navigate': 'Navigate',
  'location.driveEta': '{eta} away',
  'location.addPlaceHere': 'Save my current spot as a place',
  'location.noPlaces': 'No places saved yet.',
  'location.placeNamePrompt': 'Name this place (e.g. Home, School)',
  'location.placeLimit': 'Free households can save one place. One Roof Plus removes the limit.',
  'location.placeFailed': "Couldn't save that place — please try again.",
  'location.deletePlaceConfirm': 'Delete “{name}”?',
  'location.placesWebNote': 'Arrival and departure alerts are detected by the iPhone app; the web only shows what it recorded.',
  'location.noActivity': 'No arrivals or departures recorded yet.',
