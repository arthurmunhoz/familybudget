...
export const en = {
  ...
  'signals.openSheet': 'Send a signal',
  'signals.title': '📣 Send a signal',
  'signals.subtitle': 'A quick ping everyone at home gets right away.',
  'signals.or': 'or',
  'signals.send': 'Send',
  'signals.aiPlaceholder': 'Type what’s up…',
  'signals.aiHint': 'AI picks the emoji and wording, in your language.',
  'signals.failed': 'Could not send the signal — please try again.',
  'signals.you': 'You',
  'signals.to': 'To:',
  'signals.everyone': 'Everyone',
  'signals.call': 'Call',
  'signals.helpNote': 'Need a hand always goes to everyone.',
  'signals.gotIt': 'Got it',
  'signals.acked': 'Got it',
  'signals.seenBy': 'seen by {count}',
  'signals.preset.help': 'Need a hand',
  'signals.preset.omw': 'On my way',
  'signals.preset.late': 'Running late',
  'signals.preset.dinner': 'Dinner’s ready',
  'signals.preset.grab': 'Grab something?',
  'signals.preset.love': 'Thinking of you',
  ...
  'app.signals.name': 'Signals',
  'app.signals.desc': 'Quick pings to the family',
