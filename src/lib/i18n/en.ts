...
export const en = {
  ...
  'dates.expired': 'expired {days}d ago',
  'dates.turns': 'turns {years}',
  'dates.years': '{years} yr',
  'dates.type.birthday': 'Birthday',
  'dates.type.anniversary': 'Anniversary',
  'dates.type.renewal': 'Renewal',
  'dates.type.other': 'Other',
  'dates.newDate': 'New date',
  'dates.editDate': 'Edit date',
  'dates.titlePlaceholder': 'e.g. Mom’s birthday',
  'dates.typeLabel': 'Type',
  'dates.dateLabel': 'Date',
  'dates.repeats': 'Repeats every year',
  'dates.notesPlaceholder': 'Notes (optional)',
  'dates.saveDate': 'Save date',
  'dates.addBtn': '＋ New date',
  'dates.saveFailed': 'Could not save — please try again.',
  'dates.deleteConfirm': 'Delete “{title}”?',
  'dates.deleteDate': 'Delete date',
