...
export const pt: Record<keyof typeof en, string> = {
  ...
  'signals.openSheet': 'Mandar um sinal',
  'signals.title': '📣 Mandar um sinal',
  'signals.subtitle': 'Um aviso rápido que todo mundo em casa recebe na hora.',
  'signals.or': 'ou',
  'signals.send': 'Enviar',
  'signals.aiPlaceholder': 'Escreve o que tá rolando…',
  'signals.aiHint': 'A IA escolhe o emoji e o texto, no seu idioma.',
  'signals.failed': 'Não deu pra mandar o sinal — tenta de novo.',
  'signals.you': 'Você',
  'signals.to': 'Para:',
  'signals.everyone': 'Todo mundo',
  'signals.call': 'Ligar',
  'signals.reorder': 'Arraste para reordenar',
  'signals.helpNote': '«Preciso de ajuda» vai sempre pra todo mundo.',
  'signals.gotIt': 'Beleza',
  'signals.acked': 'Beleza',
  'signals.seenBy': 'visto por {names}',
  'signals.preset.help': 'Preciso de ajuda',
  'signals.preset.omw': 'Tô indo',
  'signals.preset.late': 'Vou me atrasar',
  'signals.preset.dinner': 'Comida pronta',
  'signals.preset.grab': 'Traz uma coisa?',
  'signals.preset.love': 'Pensando em você',
  ...
  'app.signals.name': 'Sinais',
  'app.signals.desc': 'Avisos rápidos pra família',
  'app.pets.name': 'Pets',
